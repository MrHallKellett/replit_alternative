...
def task_8():
  ...
  print("{} years of {} hair being a {} in {}?".format(hair, age, live, job))
...
def task_11():
  ...
  child1 = print("What's the name of your first child? ")
  child2 = print("What's the name of your second child? ")
  child3 = print("What's the name of your third child? ")
...
def task_14():
  ...
  where = input()
  print("With a name like", thing, "I would expect you to work in", where, "!!!")
