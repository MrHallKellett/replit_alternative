...
class UnitTests(unittest.TestCase):
  ...
  def test_test_railfence_b(self):
      # Enter code here
      self.assertEquals(encrypt_railfence("bts skytrain", 2), "bsktantsyri")


  def test_test_railfence_a(self):
      # Enter code here
      self.assertEquals(encrypt_railfence("pineapple", 5), 'peilnpepa')
  ...
  def test_test_your_cipher_b(self):
      ...
      self.assertEquals(plain, my_cipher(encrypted, "decrypt"))
  ...
  def test_test_caesar_a(self):
      # Enter code here
      self.assertEquals(caesar_decrypt("PnG", 13), "CaT")

  def test_test_rot13_b(self):
      # Enter code here
      self.assertEquals(rot13_encrypt("cat"), "png")


  def test_test_caesar_b(self):
      # Enter code here

      self.assertEquals(caesar_decrypt("p dhua jovjvshal", 7), "iwantchocolate")
