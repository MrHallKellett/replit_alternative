...
def task_3():  
  ...
  no_0208345242 = input()
  print(f"Enter the date you last called {no_0208345242}: ")
  last_called = input()
  print("So you called", no_0208345242, "on", last_called, "?")
...
def task_14():
  ...
  where = input()
  print(f"With a name like {name} I'd expect you to work in {where}!")
...
def task_15():
  ...
  if fave_num < 100 and fave_num > 9:
    print("only has 2 digits!")
  if fave_num > -100 and fave_num < -9:
    print("only has 2 digits!")
  if fave_num < 10 and fave_num > -10:
